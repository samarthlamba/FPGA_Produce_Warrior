module imageSetterCoconut(out, clk, x, y, xcoordinateApple1, ycoordinateApple1);
	...
	RAM #(		
		...
		.MEMFILE({FILES_PATH, {"coconut", "image.mem"}})) // Memory initialization
	ImageData(
	...
	RAM #(
		...
		.MEMFILE({FILES_PATH, {"coconut", "colors.mem"}}))  // Memory initialization
	ColorPalette(
