module sll(input1, ctrl_shiftamt, output1);
    input [31:0] input1;
    ...
    left_shift_16_bits shift1(input1, calc_shift_after_16);
    assign mux_16 = ctrl_shiftamt[4] ? calc_shift_after_16 : input1;
    left_shift_8_bits shift2(mux_16, calc_shift_after_8); 
    left_shift_4_bits shift3(mux_8, calc_shift_after_4);
    left_shift_2_bits shift4(mux_4, calc_shift_2);
    left_shift_1_bits shift5(mux_2, calc_shift_1);
