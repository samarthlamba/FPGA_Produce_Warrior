module imageSetterHammerSplash(out, clk, x, y, xcoordinateApple1, ycoordinateApple1);
	...
	RAM #(		
		...
		.MEMFILE({FILES_PATH, {"hammerSplash", "image.mem"}})) // Memory initialization
	ImageData(
	...
	RAM #(
		...
		.MEMFILE({FILES_PATH, {"hammerSplash", "colors.mem"}}))  // Memory initialization
	ColorPalette(
