...
HD_PWD='C:/Users/samar/Desktop/Semester 6/ECE350Labs/ECE350_Final_Project/accelerometer/accelerometer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4UserDemo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nexys4UserDemo.tcl -notrace
