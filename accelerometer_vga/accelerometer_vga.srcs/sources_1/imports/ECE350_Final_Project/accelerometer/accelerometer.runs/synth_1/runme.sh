...
HD_PWD='C:/Users/samar/Desktop/Semester 6/ECE350Labs/ECE350_Final_Project/accelerometer/accelerometer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4UserDemo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nexys4UserDemo.tcl
